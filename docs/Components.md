...
- Ausgabe:
  ...
  - sichtbare ASCII-Ausgabe ohne sichtbare horizontale Scrollbar
  - längste ASCII-Zeile wird als CSS-Basis für responsive Skalierung gesetzt
  - Skalierung orientiert sich an der tatsächlichen Heading-Containerbreite
  - bei extrem schmalen Viewports bleibt horizontaler Fallback-Scroll möglich
- Typische Nutzung:
  - Home nutzt `size="Big"`.
